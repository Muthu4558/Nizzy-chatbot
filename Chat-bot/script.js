...
function healthcareChatbot(userInput) {
  ...
  if (condition) {
    ...
    if (userInput.toLowerCase().includes("remedy")) {
      ...
      botMessage.textContent = `These symptoms are more similar to the symptoms of ${condition}. I would suggest consulting a doctor. Do you want to book an appointment?`;
      botMessage.style.cssText = `
        color: black;
        margin-bottom: 15px;
      `;
